...
void test_SetsPinDirectionsCorrectly(void){
    sut.Stop();
...
void test_GetCValidateTimeoutDuration(void) {
...
void test_PutPrintfPercentSignAtEndOfStringDisappears(void) {
...
void test_PutPrintfTwoPercentSigns(void){
    const int size = strlen("Hello% ");
    char inputBuffer[size];
    sut.PutFormatted("Hello%% ");
    sut.Get(inputBuffer, size, MAXTIME);
...
void test_PutBufferNullTerminatedString(void) {
    char data [] = "Hello, long string!";
