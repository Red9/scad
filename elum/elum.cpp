...
Elum::Elum(int RedPin, int GreenPin, int ButtonPin) {
    Start(RedPin, GreenPin, ButtonPin);
}

void Elum::Start(int RedPin, int GreenPin, int ButtonPin) {
    b_mask = 1 << ButtonPin;
...
void Elum::Flash(int Whichpin, int Period_ms, int Flash_ms) {
